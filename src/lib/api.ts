...
export interface SettingsResponse {
  ...
  expire_notification_lead_days?: number;
  login_notification?: boolean;
  renewal_notification_enabled?: boolean;
  node_status_notification_enabled?: boolean;
  load_notification_enabled?: boolean;
  traffic_notification_enabled?: boolean;
  traffic_report_notification_enabled?: boolean;
  traffic_limit_percentage?: number;
  visitor_notification_enabled?: boolean;
  unlock_quality_notification_enabled?: boolean;
  unlock_quality_notification_consecutive_rounds?: number;
  CreatedAt: string;
  UpdatedAt: string;
  [key: string]: any;
}
